pub(in crate::executor::upstream_scripts) const PRECEDENCE_TEST_OUTPUT: &str = r#"`Say' echos its argument. Its return value is of no interest.
...
"#;
pub(in crate::executor::upstream_scripts) const MAPFILE_TEST_OUTPUT: &str = r#"[0] Abcdefghijklmnop
[1] aBcdefghijklmnop
[2] abCdefghijklmnop
[3] abcDefghijklmnop
[4] abcdEfghijklmnop
